...
export const metadata = {
  ...
  keywords: ["NoDeskDeveloper", "web development services", "app development company", "UI/UX design services", "software consulting", "best web developers in India", "custom web apps", "mobile app development"],
};
...
export default function RootLayout({ children }) {
  const schemaData = {
    ...
    "description": "Top-rated IT agency offering web development services, mobile app development, UI/UX design, and software consulting in India."
  };
