...
export default function ReadyMadeSoftwarePage() {
      ...
      <div className="min-h-screen bg-black text-white pt-24 pb-24 px-6">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[...Array(6)].map((_, i) => (
              <div key={i} className="bg-white/5 backdrop-blur-xl rounded-3xl overflow-hidden border border-blue-500/20" >
                {/* Image */}
  ...
  const jsonLd = {
    ...
    "@type": "CollectionPage",
    "name": "Ready-Made Software & Clone Apps",
    "description": "Collection of production-ready software and clone applications for various industries.",
    "mainEntity": {
      "@type": "ItemList",
      "itemListElement": filteredProducts.slice(0, 10).map((p, index) => ({
        "@type": "ListItem",
        "position": index + 1,
        "item": {
