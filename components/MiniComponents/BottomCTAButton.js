    ...
    <>
      ...
      <div className="mt-20 relative">
        ...
        <div className="relative bg-linear-to-r from-white/10 to-white/5 backdrop-blur-xl border border-blue-500/30 rounded-3xl p-12 text-center">
          ...
          <p className="text-gray-400 mb-8 max-w-2xl mx-auto text-[11px]">
          ...
          <Link href={"https://api.whatsapp.com/send?phone=+918121923831&text=Hello%NoDeskDev%Team,%20I%20need%20your%20service"} className="group relative flex justify-center items-center gap-2 cursor-pointer" target="_blank">
